...
After the bootcamp, you have decided to work in the movie industry, and you've found a job where you need to manage the contacts of a famous producer.
...
![Screenshot - 1](/src/contacts1.png)
...
![Screenshot - 2](src/contacts2.png)
...
![Screenshot - 3](src/contacts3.png)
...
![Screenshot - 4](src/contacts4.png)
...
![Screenshot - 5](src/contacts5.png)

</details>

### Iteration 6 | Bonus | Styling

Add some beautiful CSS to make the app "pop".
